package com.ian.app.muviepedia.core.data.remote.model.response
...
data class DetailMovieResponse(
    ...
    data class ProductionCompanyResponse(
        ...
        @Json(name = "name") val name: String,
        @Json(name = "originCountry") val originCountry: String
    )
...
fun DetailMovieResponse.toDatabaseModel(): LocalMovieData {
