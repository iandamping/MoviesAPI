 ...
 */
class GetNowPlayingPageKeyDataSource(private val api: ApiInterface, private val scope: CoroutineScope) : PageKeyedDataSource<Int, MovieData>() {
    private val page = 1
    override fun loadInitial(params: LoadInitialParams<Int>, callback: LoadInitialCallback<Int, MovieData>) {
        scope.doSomethingWithDeferred(api.pagingGetNowPlayingMovieMovieAsync(NetworkModule.api_key, page), {
    ...
    override fun loadAfter(params: LoadParams<Int>, callback: LoadCallback<Int, MovieData>) {
        scope.doSomethingWithDeferred(api.pagingGetNowPlayingMovieMovieAsync(NetworkModule.api_key, params.key), {
