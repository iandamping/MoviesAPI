package com.ian.app.muviepedia.data.paging.movie.popular_movie
 ...
 */
class GetPopularPageKeyDataSource(private val repo: MovieRepository, private val scope: CoroutineScope) :
    ...
    override fun loadInitial(params: LoadInitialParams<Int>, callback: LoadInitialCallback<Int, MovieData>) {
        scope.extractDeferred {
            repo.getPopularMoviePagingAsync(page).apply {
    ...
    override fun loadAfter(params: LoadParams<Int>, callback: LoadCallback<Int, MovieData>) {
        scope.extractDeferred {
            repo.getPopularMoviePagingAsync(params.key).apply {
