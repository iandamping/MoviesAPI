package com.ian.app.moviesapi.ui.fragment.saved_movie
...
import com.ian.app.moviesapi.base.BaseFragment
...
class SavedMovieFragment : BaseFragment() {
    ...
    private fun onSuccessGetLocalData(data: List<LocalMovieData>) {
        ...
        actualView?.rvSavedMovie?.setUpVertical(data, R.layout.item_saved_movie, {
            with(this) {
                ivSavedMovieMovie.loadWithGlide(MovieConstant.imageFormatter + it.poster_path, context)
